...
public partial class ProductMst
{
    ...
    [Range(1, double.MaxValue, ErrorMessage = "Please enter product price greater than 0")]
    public double ProductPrice { get; set; }

    [Required(ErrorMessage = "Please enter Opening Stock")]
    [Range(1, double.MaxValue, ErrorMessage = "Please enter Opening Stock greater than 0")]
